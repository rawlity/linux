 ...
 * memory only have 28 bits (256MB), and the top 4 on the bus end for
 * tile alloc references up coming from the tile state buffer's
 * address.
 *
...
static int vc4_v3d_runtime_suspend(struct device *dev)
{
	...
	drm_gem_object_unreference(&vc4->bin_bo->base.base);
	vc4->bin_bo = NULL;
