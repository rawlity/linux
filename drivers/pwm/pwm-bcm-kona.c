...
static int kona_pwmc_config_real(struct pwm_chip *chip, struct pwm_device *pwm,
...
{
	return kona_pwmc_config_real(chip, pwm, duty_ns, period_ns,
				     pwm_is_enabled(pwm));
}
...
static int kona_pwmc_enable(struct pwm_chip *chip, struct pwm_device *pwm)
{
	...
	ret = kona_pwmc_config_real(chip, pwm, pwm_get_duty_cycle(pwm),
